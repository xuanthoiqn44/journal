 ...
 */
return [
    'Please verify email first.' => 'Vui lòng xác minh email trước.',
    'Incorrect email.' => 'Email không chính xác.',
    'Incorrect email or password.' => 'Email hoặc mật khẩu không chính xác.',
    'Your account has been blocked by admin please contact admin to unlock.' => 'Tài khoản của bạn đã bị admin khóa vui lòng liên hệ admin để mở khóa.',
    'Sorry, we are unable to reset password for email provided.' => 'Xin lỗi, chúng tôi không thể đặt lại mật khẩu cho email đã cung cấp.',
    'Check your email for further instructions.' => 'Kiểm tra email của bạn để được hướng dẫn thêm.',
    'Reset' => 'Gửi',
    'Passwords must have at least one upper-case letter and at least one digit' => 'Mật khẩu phải có ít nhất một chữ cái viết hoa và ít nhất một chữ số',
    ...
    'My Feedbacks' => 'Phản hồi của tôi',
    'What our customers say' => 'Đánh giá từ khách hàng',
    'About us' => 'Về chúng tôi',
    'Our writers' => 'Thành viên',
    'Discount' => 'Giảm giá',
    'Reviews' => 'Đánh giá',
    'Prices' => 'Bảng giá',
    'Editing' => 'Chỉnh sửa',
    'Rewriting' => 'Rewriting',
    'Copywriting' => 'Văn bản',
    'Math/Science' => 'Khoa học/toán học',
    'Proofreading' => 'Đọc thử',
    'Writing services' => 'Viết bài',
    'Services' => 'Dịch vụ',
    'Hi' => 'Chào',
    'Login' => 'Đăng nhập',
    'Order' => 'Tạo Order',
